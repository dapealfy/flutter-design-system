...
class ButtonAlertInfo extends StatefulWidget {
  ...
  @override
  State<ButtonAlertInfo> createState() => _ButtonAlertInfoState();
}

class _ButtonAlertInfoState extends State<ButtonAlertInfo> {
    ...
    return SizedBox(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          border: _isFocused
              ? Border.all(
                  color: FunDsColors.colorBlue200,
                  width: 1.0,
          ...
          decoration: ShapeDecoration(
            ...
            shadows: widget.enabled
                ? const [
                    ...
                    BoxShadow(
                      color: FunDsColors.colorBlue500,
                      blurRadius: 0,
                      offset: Offset(0, 0),
                      spreadRadius: 1,
                    ),
  ...
  ButtonStyle enabledButtonStyle() {
    return ButtonStyle(
      ...
      overlayColor: MaterialStateProperty.all(FunDsColors.colorBlue600),
      backgroundColor: MaterialStateProperty.all(
        FunDsColors.colorBlue500.withOpacity(0.8),
      ),
      shape: MaterialStateProperty.all(
        RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(internalButtonType.radius),
